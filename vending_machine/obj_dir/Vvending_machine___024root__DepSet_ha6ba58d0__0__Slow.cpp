...
VL_ATTR_COLD void Vvending_machine___024root___dump_triggers__act(Vvending_machine___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @([changed] i_input_coin or [changed] o_output_item)\n");
    }
    if ((2ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(posedge clk)\n");
    }
    if ((4ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @(posedge clk or [changed] i_input_coin or [changed] o_output_item)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vvending_machine___024root___dump_triggers__nba(Vvending_machine___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @([changed] i_input_coin or [changed] o_output_item)\n");
    }
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(posedge clk)\n");
    }
    if ((4ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @(posedge clk or [changed] i_input_coin or [changed] o_output_item)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vvending_machine___024root___ctor_var_reset(Vvending_machine___024root* vlSelf) {
    ...
    vlSelf->__Vdly__vending_machine__DOT__wait_time = VL_RAND_RESET_I(32);
    vlSelf->__Vtrigprevexpr___TOP__i_input_coin__0 = VL_RAND_RESET_I(3);
    vlSelf->__Vtrigprevexpr___TOP__o_output_item__0 = VL_RAND_RESET_I(4);

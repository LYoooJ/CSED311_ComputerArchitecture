...
VL_ATTR_COLD void Vvending_machine___024root___eval_initial(Vvending_machine___024root* vlSelf) {
    ...
    vlSelf->__Vtrigprevexpr___TOP__o_return_coin__1 
        = vlSelf->o_return_coin;
    vlSelf->__Vtrigprevexpr___TOP__o_return_coin__2 
        = vlSelf->o_return_coin;
...
VL_ATTR_COLD void Vvending_machine___024root___eval_initial__TOP(Vvending_machine___024root* vlSelf) {
    ...
    vlSelf->vending_machine__DOT__check_time_and_coin_module__DOT__temp = 0U;
    vlSelf->vending_machine__DOT__check_time_and_coin_module__DOT__x = 0U;
    vlSelf->vending_machine__DOT__check_time_and_coin_module__DOT__y = 0U;
    vlSelf->vending_machine__DOT__check_time_and_coin_module__DOT__z = 0U;
}
...
VL_ATTR_COLD void Vvending_machine___024root___dump_triggers__stl(Vvending_machine___024root* vlSelf) {
    ...
    if ((2ULL & vlSelf->__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 1 is active: @([hybrid] o_return_coin)\n");
    }
}
#endif  // VL_DEBUG
...
void Vvending_machine___024root___ico_comb__TOP__0(Vvending_machine___024root* vlSelf);
...
VL_ATTR_COLD void Vvending_machine___024root___dump_triggers__ico(Vvending_machine___024root* vlSelf) {
    ...
    if ((2ULL & vlSelf->__VicoTriggered.word(0U))) {
        VL_DBG_MSGF("         'ico' region trigger index 1 is active: @([hybrid] o_return_coin)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vvending_machine___024root___dump_triggers__act(Vvending_machine___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @([hybrid] o_return_coin)\n");
    }
    if ((2ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @([changed] i_input_coin or [changed] i_select_item)\n");
    }
    if ((4ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @(posedge clk)\n");
    }
    if ((8ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 3 is active: @(posedge clk or [changed] i_input_coin or [changed] i_select_item)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vvending_machine___024root___dump_triggers__nba(Vvending_machine___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @([hybrid] o_return_coin)\n");
    }
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @([changed] i_input_coin or [changed] i_select_item)\n");
    }
    if ((4ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @(posedge clk)\n");
    }
    if ((8ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 3 is active: @(posedge clk or [changed] i_input_coin or [changed] i_select_item)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vvending_machine___024root___ctor_var_reset(Vvending_machine___024root* vlSelf) {
    ...
    vlSelf->vending_machine__DOT__check_time_and_coin_module__DOT__x = VL_RAND_RESET_I(32);
    vlSelf->vending_machine__DOT__check_time_and_coin_module__DOT__y = VL_RAND_RESET_I(32);
    vlSelf->vending_machine__DOT__check_time_and_coin_module__DOT__z = VL_RAND_RESET_I(32);
    vlSelf->vending_machine__DOT__check_time_and_coin_module__DOT__temp = VL_RAND_RESET_I(32);
    vlSelf->vending_machine__DOT__check_time_and_coin_module__DOT__unnamedblk1__DOT__i = VL_RAND_RESET_I(32);
    vlSelf->vending_machine__DOT__calculate_current_state_module__DOT__i = VL_RAND_RESET_I(32);
    vlSelf->__Vtrigprevexpr___TOP__o_return_coin__0 = VL_RAND_RESET_I(3);
    vlSelf->__VstlDidInit = 0;
    vlSelf->__Vtrigprevexpr___TOP__o_return_coin__1 = VL_RAND_RESET_I(3);
    vlSelf->__VicoDidInit = 0;
    vlSelf->__Vtrigprevexpr___TOP__o_return_coin__2 = VL_RAND_RESET_I(3);

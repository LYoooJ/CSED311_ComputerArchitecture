...
void Vvending_machine___024root___eval_triggers__ico(Vvending_machine___024root* vlSelf) {
    ...
    vlSelf->__VicoTriggered.set(1U, ((IData)(vlSelf->o_return_coin) 
                                     != (IData)(vlSelf->__Vtrigprevexpr___TOP__o_return_coin__1)));
...
void Vvending_machine___024root___eval_triggers__act(Vvending_machine___024root* vlSelf) {
    ...
    // Body
    vlSelf->__VactTriggered.set(0U, ((IData)(vlSelf->o_return_coin) 
                                     != (IData)(vlSelf->__Vtrigprevexpr___TOP__o_return_coin__2)));
    vlSelf->__VactTriggered.set(1U, (((IData)(vlSelf->i_input_coin) 

...
void Vvending_machine___024root__trace_chg_0_sub_0(Vvending_machine___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(((vlSelf->__Vm_traceActivity[1U] 
        ...
        bufp->chgIData(oldp+9,(vlSelf->vending_machine__DOT__input_total),32);
        bufp->chgIData(oldp+10,(vlSelf->vending_machine__DOT__output_total),32);
        bufp->chgIData(oldp+11,(vlSelf->vending_machine__DOT__return_total),32);
        bufp->chgIData(oldp+12,(vlSelf->vending_machine__DOT__check_time_and_coin_module__DOT__x),32);
        bufp->chgIData(oldp+13,(vlSelf->vending_machine__DOT__check_time_and_coin_module__DOT__y),32);
        bufp->chgIData(oldp+14,(vlSelf->vending_machine__DOT__check_time_and_coin_module__DOT__z),32);
        bufp->chgIData(oldp+15,(vlSelf->vending_machine__DOT__check_time_and_coin_module__DOT__temp),32);
    }
    bufp->chgBit(oldp+16,(vlSelf->clk));
    bufp->chgBit(oldp+17,(vlSelf->reset_n));
    bufp->chgCData(oldp+18,(vlSelf->i_input_coin),3);
    bufp->chgCData(oldp+19,(vlSelf->i_select_item),4);
    bufp->chgBit(oldp+20,(vlSelf->i_trigger_return));
    bufp->chgCData(oldp+21,(vlSelf->o_available_item),4);
    bufp->chgCData(oldp+22,(vlSelf->o_output_item),4);
    bufp->chgCData(oldp+23,(vlSelf->o_return_coin),3);
    bufp->chgIData(oldp+24,(vlSelf->vending_machine__DOT__current_total),32);
    bufp->chgIData(oldp+25,(vlSelf->vending_machine__DOT__wait_time),32);
    bufp->chgCData(oldp+26,((7U & vlSelf->vending_machine__DOT__current_total)),3);
    bufp->chgIData(oldp+27,(vlSelf->vending_machine__DOT__check_time_and_coin_module__DOT__unnamedblk1__DOT__i),32);
}

...
VL_INLINE_OPT void Valu___024root___ico_sequent__TOP__0(Valu___024root* vlSelf) {
    ...
    // Body
    vlSelf->OverflowFlag = ((1U & (~ ((IData)(vlSelf->FuncCode) 
                                      >> 3U))) && (
                                                   (1U 
                                                    & (~ 
                                                       ((IData)(vlSelf->FuncCode) 
                                                        >> 2U))) 
                                                   && ((1U 
                                                        & (~ 
                                                           ((IData)(vlSelf->FuncCode) 
                                                           ...
                                                           && (0U 
                                                               ...
                                                               ((~ 
                                                                ...
                                                                & VL_SHIFTR_III(32,32,32, 
                                                                                ...
                                                                                + (IData)(vlSelf->B)) 
                                                                                ^ (IData)(vlSelf->A)), 0xfU)))))));
    vlSelf->C = (0xffffU & ((8U & (IData)(vlSelf->FuncCode))
                             ? ((4U & (IData)(vlSelf->FuncCode))
                                 ? ((2U & (IData)(vlSelf->FuncCode))
                                     ? ((1U & (IData)(vlSelf->FuncCode))
                                         ? 0U : ((IData)(1U) 
                                                 + 
                                                 (~ (IData)(vlSelf->A))))
                                     : ((1U & (IData)(vlSelf->FuncCode))
                                         ? VL_SHIFTR_III(16,16,32, (IData)(vlSelf->A), 1U)
                                         : VL_SHIFTL_III(16,16,32, (IData)(vlSelf->A), 1U)))
                                 : ((2U & (IData)(vlSelf->FuncCode))
                                     ? ((1U & (IData)(vlSelf->FuncCode))
                                         ? VL_SHIFTR_III(16,16,32, (IData)(vlSelf->A), 1U)
                                         : VL_SHIFTL_III(16,16,32, (IData)(vlSelf->A), 1U))
